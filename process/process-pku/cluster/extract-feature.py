...
# 设置路径
OutputCSV = 'C:\\Users\\86178\\Desktop\\attention-gpt\\dataset\\pku-attention\\ClusteringResults.csv'
...
def perform_birch_clustering(data, threshold, branching_factor, min_threshold=0.001):
    while threshold > min_threshold:
        ...
        if len(unique_labels) >= 3:
            ...
            threshold /= 2  # Decrease threshold
...
def process_combination(row, df):
    ...
    try:
        ...
        print(f"Processed Participant: {participant}, Trail: {movie}, Type: {patient_type}")
...
# 文件路径
asd_file1 = 'C:\\Users\\86178\\Desktop\\attention-gpt\\dataset\\pku-attention\\HFA.csv'
asd_file2 = 'C:\\Users\\86178\\Desktop\\attention-gpt\\dataset\\pku-attention\\LFA.csv'
td_file = 'C:\\Users\\86178\\Desktop\\attention-gpt\\dataset\\pku-attention\\TD.csv'
